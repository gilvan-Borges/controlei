...
export class InvestmentService {
  ...
  addTransaction(investmentId: string, request: CreateInvestmentTransactionRequest): Observable<InvestmentTransaction> {
    return this.http.post<InvestmentTransaction>(`${this.baseUrl}/${investmentId}/transactions`, request);
  }

  listTransactions(investmentId: string): Observable<InvestmentTransaction[]> {
    return this.http.get<InvestmentTransaction[]>(`${this.baseUrl}/${investmentId}/history`);
  }

  getPortfolioSummary(): Observable<InvestmentPortfolioSummary> {
    return this.http.get<InvestmentPortfolioSummary>(`${this.baseUrl}/portfolio-summary`);
  }
}
